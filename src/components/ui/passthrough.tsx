...
`
    ...
    confirmdialog: {
        root: {
            className: classNames(
                ...
                ':uno: before:(absolute w-0 -top-3 h-0 border-transparent border-solid ml-6 border-x-[0.75rem] border-b-[0.75rem] border-t-0 border-b-white) dark:before:border-b-gray-900',
    ...
    confirmpopup: {
        root: {
            className: classNames(
                'bg-white text-gray-700 border border-primary rounded-md shadow-lg',
                'z-40 transform origin-center',
                'mt-3 absolute left-0 top-0',
                ':uno: before:(absolute w-0 -top-3 h-0 border-transparent border-solid ml-6 border-x-[0.75rem] border-b-[0.75rem] border-t-0 border-b-white) dark:before:border-b-gray-900',
                'dark:border dark:border-blue-900/40 dark:bg-gray-900  dark:text-white/80'
    ...
    menu: {
        root: 'p-1 bg-white dark:bg-gray-900 text-gray-700 dark:text-white/80 border border-gray-200 dark:border-blue-900/40 rounded-md w-48 shadow-md',
        menu: {
            className: classNames('m-0 p-0 list-none', 'outline-none')
        },
        content: ({ state }) => ({
            className: classNames(
                'text-gray-700 dark:text-white/80 transition-shadow duration-200',
                'hover:(text-gray-700 bg-gray-200 rounded-md) dark:hover:(text-white/80 bg-gray-800/80)', // Hover
                {
                    'text-gray-700 dark:text-white/80 dark:bg-gray-800/90': state.focused
                }
            )
        }),
        action: {
            className: classNames('text-gray-700 dark:text-white/80 py-2 px-3 select-none', 'cursor-pointer flex items-center no-underline overflow-hidden relative')
        },
        menuitem: {
            className: classNames('hover:(bg-gray-200 rounded-md)')
        },
        icon: 'text-gray-600 dark:text-white/70 mr-2',
        submenuHeader: {
            className: classNames('m-0 p-2 text-gray-700 dark:text-white/80 bg-white dark:bg-gray-900 font-bold rounded-tl-none rounded-tr-none')
        },
    ...
    tieredmenu: {
        root: {
            className: classNames('py-1 bg-white border border-gray-300 rounded-lg w-[12.5rem] shadow-md', 'dark:border-blue-900/40 dark:bg-gray-900')
        },
        menu: {
            className: classNames('outline-none', 'm-0 p-0 list-none')
        },
        ...
        content: ({ context }) => ({
            className: classNames(
                'transition-shadow duration-200 border-none rounded-none ahihihihi',
        ...
        action: ({ context }) => ({
            className: classNames('py-1 px-3 select-none', 'flex items-center cursor-pointer no-underline relative overflow-hidden', {
                'text-gray-700 dark:text-white/80 hover:text-gray-700 dark:hover:text-white/80 hover:bg-gray-200 dark:hover:bg-gray-800/80': !context.active,
                'text-blue-600 bg-blue-100': context.active
            })
        }),
